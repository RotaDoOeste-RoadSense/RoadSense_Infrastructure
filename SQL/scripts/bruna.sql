...
CREATE TABLE `ESTRUTURA` (
  ...
  `coordenadas_latitude_estrutura` varchar(20) NOT NULL,
  `coordenadas_longitude_estrutura` varchar(20) NOT NULL,
...
CREATE TABLE `VEGETACAO` (
  ...
  CONSTRAINT `IMAGE_DATA_ibfk_1` FOREIGN KEY (`ID_IMAGE_DATA`) REFERENCES `IMAGE_DATA` (`id`)
