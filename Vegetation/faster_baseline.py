...
transform = transforms.Compose([
    transforms.ToTensor(),  # Converte a imagem para um tensor (com valores normalizados entre 0 e 1)
    #transforms.Resize((448, 448)),  # Redimensiona para 224x224 (ou qualquer outro tamanho)
