...
CONSTRAINT `image_fk` FOREIGN KEY (`image_id`) REFERENCES `IMAGE_DATA` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `guardrail_details` (
  ...
  `y2` float DEFAULT NULL, 
  PRIMARY KEY (`id`),
  KEY `all_guardrail_matched_id` (`all_guardrail_matched_id`),
  CONSTRAINT `guardrail_matched_fk` FOREIGN KEY (`all_guardrail_matched_id`) REFERENCES `all_guardrail_matched` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;