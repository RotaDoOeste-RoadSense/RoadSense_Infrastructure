...
print(f'starting loading model')
...
if __name__ == '__main__':
    ...
    #dataset_dir = '/media/rdt/hd2/vegetacao/Dataset27-janeiro/val'
    dataset_dir = '/home/servidor/val'
    ...
    for folder in folders:
        ...
        for image_path in tqdm(images):
            ...
            output_json = postprocess(yolo(img))
    ...
    plt.savefig('confusion_matrix_cv2_and_torch.png')
